...
def main():
    Bernard = SummaryWriter(comment='BM5')    # Assigning an instance of SummaryWriter class to Bernard variable, to be used to write summaries to TensorBoard log files.
