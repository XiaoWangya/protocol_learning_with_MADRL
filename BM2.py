...
def main():
    Bernard = SummaryWriter(comment='_BM2')    # Assigning an instance of SummaryWriter class to Bernard variable, to be used to write summaries to TensorBoard log files.
